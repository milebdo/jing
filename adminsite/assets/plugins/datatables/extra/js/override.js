...
$.extend(true, $.fn.dataTable.defaults, {
	...
	"fnInitComplete": function(oSettings, json) {
		...
		if (currentId) {
			...
			thisLengthSelect.addClass('form-control selectpicker show-menu-arrow show-tick').attr({
				'id': currentId + '_length_select',
				'data-width': "100px",
			...
			thisFilterInput.addClass('form-control').attr({
				'id': currentId + '_filter_input',
				'placeholder': oSettings.oLanguage.sSearch
			});
