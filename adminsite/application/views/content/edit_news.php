...
<div id="main">
	...
	<div id="content">
		...
		<div class="col-lg-12">
			...
			action="<?php echo base_url() . 'news/writecontent/edit'; ?>" novalidate>
				<input type="hidden" name="idnews" value="<?php echo $content->news_id;?>">
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<select name="category" class="selectpicker form-control">
								<option value="" <?php echo $content->category_id == $category[0]->category_id ? 'selected="selected"' : ''; ?>> Pilih Kategori </option>
								<?php
									if($category) {
										foreach ($category as $cat)
										{
								?>
										<option value="<?php echo $cat->category_id;?>" <?php echo $content->category_id == $cat->category_id ? 'selected="selected"' : ''; ?>> <?php echo $cat->name;?> </option>
								<?php 
										}
								   } 
								?>
					...
					<div class="form-group">
							...
							<div>
								<img height=100 alt="" src="<?php echo base_url().$content->image;?>" />
								<p />
				...
				<div class="col-lg-12">
					<div class="control-group">
                         ...
                         <div>
                              <textarea name="content" class="input-large textarea" id="tinymce_intro" placeholder="Enter text ..."><?php if(isset($content)) echo $content->content;?></textarea>
                         </div>
                   </div>
				</div>
				<div class="clearfix breakline"></div>
